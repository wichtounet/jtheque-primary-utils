...
final class MultiLineFieldGetterFactory extends AbstractFieldGetterFactory {
    ...
    public FieldGetter factor(Element element, XMLReader reader) throws XMLException {
        ...
        getter.setStartCondition(getCondition(element, "startcondition", reader));
        getter.setStopCondition(getCondition(element, "stopcondition", reader));
        getter.setGetCondition(getCondition(element, "getcondition", reader));
