...
/**
 * An action to validate the type view.
 *
 * @author Baptiste Wicht
 */
public final class AcValidateTypeView extends JThequeAction {
    ...
    /**
     * Construct a AcValidateTypeView.
     */
    public AcValidateTypeView() {
        super("type.actions.ok");
    }

    @Override
    public void actionPerformed(ActionEvent e) {
        ITypeView view = typeController.getView();

        if (view.validateContent()) {
            typeController.save(view.getFieldName().getText());
